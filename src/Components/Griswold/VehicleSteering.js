    ...
    <Grid container direction="column" spacing={3}>
      ...
      <Grid container item justify="center">
        <DetailCard 
          ...
          body={["The ship is rotated by comparing the ship forward vector to the pawn forward vector (which is inherited from the camera forward vector), multiplying it by the time elapsed since the last tick and the ships maximum rotation rate and adding the result to the current rotation."]}
        />
      </Grid>
    </Grid>
    </>
